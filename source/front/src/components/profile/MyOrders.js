...
import { getMyOrders, downloadOrder } from '#c/functions/index';
...
class MyOrders extends React.Component {
  ...
  render() {
    let { t } = this.props;
    let { data, headCells, newText, buttonText, loading } = this.state;
    // if (redirect) {
                            ...
                            <div className={'the-order-purple p-4'}>
                              <div className={'the-order-title'}>
                                ...
                                <div className={'the-order-body-line'}>
                                  ...
                                  <div className={'the-order-body-line'} key={i}>
                                    <Link
                                      className={'gfdsdf'}
                                    ...
                                    <Button
                                      ...
                                      onClick={(e)=>this.generatePDF(e,dat._id,i)}>
                                      {loading === i ? <CircularProgress size={20} color="secondary" /> : t('download Order')}
                                    </Button>
                                  </div>
                                </div>
                              </div>
