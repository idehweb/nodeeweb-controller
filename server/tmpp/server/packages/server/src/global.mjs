...
let learn_mode = process.env.learn_mode;
...
let global = {
    ...
    theme: (mode = 'admin', req, res, next) => {
        ...
        return new Promise(function (resolve, reject) {
            ...
            Settings.findOne({}, 'currency unitMass tax taxAmount passwordAuthentication registerExtraFields orderExtraFields', function (set_err, setting) {
