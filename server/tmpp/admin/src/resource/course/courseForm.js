...
// });
  ...
  return (
    ...
    >
      ...
      <TextInput source={"miniTitle." + translate("lan")} label={translate("resources.course.miniTitle")}/>
      ...
      {/*<ReferenceArrayInput*/}
      {/*label={translate("resources.course.attributes")}*/}
      {/*source="attributes" reference="attributes">*/}
      {/*<SelectArrayInput optionText="name.fa" optionValue="_id"/>*/}
      {/*</ReferenceArrayInput>*/}

      <AtrRefField label={translate("resources.course.attributes")}
                   source="attributes"
      ...
      <SelectInput
        label={translate("resources.course.type")}
        fullWidth
        className={"mb-20"}
        source="type"
        choices={ProductType() }
            ...
            return [<div className={"row mb-20"}>
              ...
              <div className={"col-md-4"}>
                <NumberInput
                  ...
                  label={translate("resources.course.weight")}
                  // record={scopedFormData}
                  {...rest}
                />
              </div>
              ...
              <div className={"row mb-20"} key={2}>
                <div className={"col-md-3"}>
                  <TextInput
                    ...
                    label={translate("resources.course.source")}
                ...
                <div className={"col-md-3"}>
                  <TextInput
                    ...
                    label={translate("resources.course.minPrice")}
                    format={v => {
                      if (!v) return;
                ...
                <div className={"col-md-3"}>
                  <TextInput
                    ...
                    label={translate("resources.course.maxPrice")}
                    format={v => {
                      if (!v) return;
                ...
                <div className={"col-md-3"}>
                  <TextInput
                    ...
                    label={translate("resources.course.formula")}
