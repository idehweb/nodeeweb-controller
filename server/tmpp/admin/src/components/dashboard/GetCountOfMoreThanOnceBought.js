...
const GetCountOfMoreThanOnceBought = (props) => {
    const { icon='Rowing', title='اونایی که بیشتر از یبار خرید داشتن', subtitle='', to='', children } = props;
    const classes = useStyles(props);
    const [theData,setTheData]=useState(0);
    const getShopData = () => {
        API.get("/settings/get-count-of-more-than-once-bought").then(({ data = {} }) => {
            // setLoading(false);
...
export default GetCountOfMoreThanOnceBought;
